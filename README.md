...
Everything below is generated by `make eval` — confidence threshold 0.70, Layer 3 mode `replay`, corpus identified by the config hash in the Corpus table below. Do not edit by hand; `make eval-check` fails when this block is stale.
